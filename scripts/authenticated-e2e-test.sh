...
IMAGE="${HUBUUM_AUTH_E2E_BACKEND_IMAGE:-ghcr.io/hubuum/hubuum-server:v0.0.16}"
...
BACKEND_BASE_URL="${BASE_URL}" \
  ...
  npx playwright test tests/e2e/authenticated-smoke.spec.ts tests/e2e/workspace-quality.spec.ts tests/e2e/schema-workspace.spec.ts tests/e2e/task-cancellation.spec.ts tests/e2e/task-discovery.spec.ts --workers=1 "$@"
