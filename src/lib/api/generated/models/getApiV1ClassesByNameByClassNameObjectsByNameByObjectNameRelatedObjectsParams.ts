...
export type GetApiV1ClassesByNameByClassNameObjectsByNameByObjectNameRelatedObjectsParams = {
/**
 * Comma-separated class IDs to exclude from the returned connected objects
 */
ignore_classes?: string;
/**
 * Exclude connected objects in the same class as the root object. Defaults to true
 */
ignore_self_class?: boolean;
/**
