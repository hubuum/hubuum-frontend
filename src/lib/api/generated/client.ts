...
const res = await fetch(getPostApiV0AuthLogoutTokenUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
    body: JSON.stringify(logoutTokenRequest)
  }
)
...
const res = await fetch(getPostApiV1ClassesUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
    body: JSON.stringify(newHubuumClass)
  }
)
...
const res = await fetch(getPatchApiV1ClassesByNameByClassNameObjectsByNameByObjectNameDataUrl(className,objectName),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json-patch+json', ...getHeaders(options?.headers) },
...
/**
 * Returns the complete bounded neighborhood graph as one response. This endpoint is not paginated: limit is a maximum related-node safety bound, include_total has no effect, and X-Total-Count is not returned.
...
export const deleteApiV1ClassesByClassId = async (classId: number, options?: RequestInit): Promise<deleteApiV1ClassesByClassIdResponse> => {
  ...
  const data: deleteApiV1ClassesByClassIdResponse['data'] = body ? JSON.parse(body) : undefined
...
const res = await fetch(getPostApiV1ClassesByClassIdRelationsUrl(classId),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
    body: JSON.stringify(newHubuumClassRelationFromClass)
  }
)
...
export const deleteApiV1ClassesByClassIdByFromObjectIdRelationsByToClassIdByToObjectId = async (classId: number,
  ...
  const data: deleteApiV1ClassesByClassIdByFromObjectIdRelationsByToClassIdByToObjectIdResponse['data'] = body ? JSON.parse(body) : undefined
...
export const deleteApiV1ClassesByClassIdByObjectId = async (classId: number,
  ...
  const data: deleteApiV1ClassesByClassIdByObjectIdResponse['data'] = body ? JSON.parse(body) : undefined
...
const res = await fetch(getPostApiV1CollectionsUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
    body: JSON.stringify(newCollectionWithAssignee)
  }
)
...
export const deleteApiV1CollectionsByCollectionId = async (collectionId: number, options?: RequestInit): Promise<deleteApiV1CollectionsByCollectionIdResponse> => {
  ...
  const data: deleteApiV1CollectionsByCollectionIdResponse['data'] = body ? JSON.parse(body) : undefined
...
export const deleteApiV1CollectionsByCollectionIdEventSubscriptionsBySubscriptionId = async (collectionId: number,
  ...
  const data: deleteApiV1CollectionsByCollectionIdEventSubscriptionsBySubscriptionIdResponse['data'] = body ? JSON.parse(body) : undefined
...
const res = await fetch(getPutApiV1CollectionsByCollectionIdParentUrl(collectionId),
  {
    ...
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
    body: JSON.stringify(updateCollectionParent)
  }
)
...
export const getApiV1CollectionsByCollectionIdPermissionsGroupByGroupIdByPermission = async (collectionId: number,
  ...
  const data: getApiV1CollectionsByCollectionIdPermissionsGroupByGroupIdByPermissionResponse['data'] = body ? JSON.parse(body) : undefined
...
export const deleteApiV1EventSinksBySinkId = async (sinkId: number, options?: RequestInit): Promise<deleteApiV1EventSinksBySinkIdResponse> => {
  ...
  const data: deleteApiV1EventSinksBySinkIdResponse['data'] = body ? JSON.parse(body) : undefined
...
const res = await fetch(getPostApiV1ExportTemplatesUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
    body: JSON.stringify(newExportTemplate)
  }
)
...
export const deleteApiV1ExportTemplatesByTemplateId = async (templateId: number, options?: RequestInit): Promise<deleteApiV1ExportTemplatesByTemplateIdResponse> => {
  ...
  const data: deleteApiV1ExportTemplatesByTemplateIdResponse['data'] = body ? JSON.parse(body) : undefined
...
const res = await fetch(getPatchApiV1ExportTemplatesByTemplateIdUrl(templateId),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
    body: JSON.stringify(updateExportTemplate)
  }
)
...
const res = await fetch(getPostApiV1ExportTemplatesByTemplateIdExportsUrl(templateId),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
    body: JSON.stringify(exportTemplateRunRequest)
  }
)
...
export const getApiV1ExportsByTaskIdOutput = async (taskId: number, options?: RequestInit): Promise<getApiV1ExportsByTaskIdOutputResponse> => {
  ...
  const data: getApiV1ExportsByTaskIdOutputResponse['data'] = body ? (contentType.includes('json') ? JSON.parse(body) : body) : {}
...
export const deleteApiV1IamGroupsByGroupId = async (groupId: number, options?: RequestInit): Promise<deleteApiV1IamGroupsByGroupIdResponse> => {
  ...
  const data: deleteApiV1IamGroupsByGroupIdResponse['data'] = body ? JSON.parse(body) : undefined
...
export const deleteApiV1IamGroupsByGroupIdMembersByPrincipalId = async (groupId: number,
  ...
  const data: deleteApiV1IamGroupsByGroupIdMembersByPrincipalIdResponse['data'] = body ? JSON.parse(body) : undefined
...
export const deleteApiV1IamMeSettings = async ( options?: RequestInit): Promise<deleteApiV1IamMeSettingsResponse> => {
  ...
  const data: deleteApiV1IamMeSettingsResponse['data'] = body ? JSON.parse(body) : undefined
...
export const deleteApiV1IamPrincipalsByPrincipalIdSettings = async (principalId: number, options?: RequestInit): Promise<deleteApiV1IamPrincipalsByPrincipalIdSettingsResponse> => {
  ...
  const data: deleteApiV1IamPrincipalsByPrincipalIdSettingsResponse['data'] = body ? JSON.parse(body) : undefined
...
export const postApiV1IamPrincipalsByPrincipalIdTokensByTokenIdRevoke = async (principalId: number,
  ...
  const data: postApiV1IamPrincipalsByPrincipalIdTokensByTokenIdRevokeResponse['data'] = body ? JSON.parse(body) : undefined
...
export const deleteApiV1IamServiceAccountsByServiceAccountId = async (serviceAccountId: number, options?: RequestInit): Promise<deleteApiV1IamServiceAccountsByServiceAccountIdResponse> => {
  ...
  const data: deleteApiV1IamServiceAccountsByServiceAccountIdResponse['data'] = body ? JSON.parse(body) : undefined
...
const res = await fetch(getPatchApiV1IamServiceAccountsByServiceAccountIdUrl(serviceAccountId),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
    body: JSON.stringify(updateServiceAccount)
  }
)
...
export const deleteApiV1IamUsersByUserId = async (userId: number, options?: RequestInit): Promise<deleteApiV1IamUsersByUserIdResponse> => {
  ...
  const data: deleteApiV1IamUsersByUserIdResponse['data'] = body ? JSON.parse(body) : undefined
...
export const postApiV1IamUsersByUserIdAnonymize = async (userId: number, options?: RequestInit): Promise<postApiV1IamUsersByUserIdAnonymizeResponse> => {
  ...
  const data: postApiV1IamUsersByUserIdAnonymizeResponse['data'] = body ? JSON.parse(body) : undefined
...
const res = await fetch(getPostApiV1RelationsClassesUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
    body: JSON.stringify(newHubuumClassRelation)
  }
)
...
export const deleteApiV1RelationsClassesByRelationId = async (relationId: number, options?: RequestInit): Promise<deleteApiV1RelationsClassesByRelationIdResponse> => {
  ...
  const data: deleteApiV1RelationsClassesByRelationIdResponse['data'] = body ? JSON.parse(body) : undefined
...
const res = await fetch(getPostApiV1RelationsObjectsUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
    body: JSON.stringify(newHubuumObjectRelation)
  }
)
...
export const deleteApiV1RelationsObjectsByRelationId = async (relationId: number, options?: RequestInit): Promise<deleteApiV1RelationsObjectsByRelationIdResponse> => {
  ...
  const data: deleteApiV1RelationsObjectsByRelationIdResponse['data'] = body ? JSON.parse(body) : undefined
...
const res = await fetch(getPostApiV1RemoteTargetsUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
    body: JSON.stringify(newRemoteTarget)
  }
)
...
export const deleteApiV1RemoteTargetsByTargetId = async (targetId: number, options?: RequestInit): Promise<deleteApiV1RemoteTargetsByTargetIdResponse> => {
  ...
  const data: deleteApiV1RemoteTargetsByTargetIdResponse['data'] = body ? JSON.parse(body) : undefined
...
const res = await fetch(getPatchApiV1RemoteTargetsByTargetIdUrl(targetId),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
    body: JSON.stringify(updateRemoteTarget)
  }
)
...
const res = await fetch(getPostApiV1RemoteTargetsByTargetIdInvokeUrl(targetId),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
    body: JSON.stringify(remoteTargetInvokeRequest)
  }
)
...
export type postApiV1RestoresByRestoreIdConfirmResponse202 = {
  data: RestoreStageResponse
  status: 202
}
...
export type postApiV1RestoresByRestoreIdConfirmResponseSuccess = (postApiV1RestoresByRestoreIdConfirmResponse202) & {
  headers: Headers;
};
