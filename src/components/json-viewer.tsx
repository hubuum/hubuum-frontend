...
export function JsonViewer({ value, defaultTab = "overview" }: JsonViewerProps) {
      ...
      {activeTab === "overview" ? (
        <div className="json-viewer-panel" role="tabpanel">
          {overviewEntries.length > 0 ? (
            ...
            <div className="muted">This JSON value does not have child fields to summarize.</div>
          )}

          {overviewEntries.length > 0 && filteredOverviewEntries.length === 0 ? (
