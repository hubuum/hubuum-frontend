    ...
    <div className="keyboard-help-backdrop">
      <div className="keyboard-help card">
        <div className="keyboard-help-header">
          ...
          <button type="button" className="ghost icon-button" onClick={onClose} aria-label="Close help">
              ...
              <div className="keyboard-shortcut-keys">
                {shortcut.keys.map((key, keyIndex) => (
                  <span key={keyIndex}>
                    ...
                    {keyIndex < shortcut.keys.length - 1 ? <span className="keyboard-plus">+</span> : null}
                  </span>
                ))}
              </div>
